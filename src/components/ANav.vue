...
<template>
    <div class="in-nav" :class="{ scrolled: isScrolled }">
        ...
        <!-- Botão burger (mobile) -->
        <button class="burger-btn" @click="toggleMenu" :aria-expanded="isOpen" aria-controls="mobile-menu"
            aria-label="Abrir menu">
            <img src="/images/burguer.svg" alt="" />
        </button>

        <!-- Menu mobile -->
        <nav id="mobile-menu" class="mobile-menu" :class="{ open: isOpen }">
